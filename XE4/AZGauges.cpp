...
__fastcall TAZGauge::TAZGauge(TComponent *AOwner)
...
Longint __fastcall TAZGauge::GetPercentDone()
{
  return SolveForY(FCurValue - FMinValue, FMaxValue - FMinValue);
}

void __fastcall TAZGauge::Paint()
{
...
void __fastcall TAZGauge::PaintBackground(Graphics::TBitmap* AnImage)
{
  TRect  ARect;
...
void __fastcall TAZGauge::PaintAsText(Graphics::TBitmap* AnImage, const TRect& PaintRect)
{
  String S;
  Integer X, Y;
...
void __fastcall TAZGauge::PaintAsNothing(Graphics::TBitmap* AnImage, const TRect &PaintRect)
{
    AnImage->Canvas->Brush->Color = BackColor;
    AnImage->Canvas->FillRect(PaintRect);
}

void __fastcall TAZGauge::PaintAsBar(Graphics::TBitmap* AnImage, const TRect& PaintRect)
{
  Longint  FillSize;
  Integer  W, H;
...
void __fastcall TAZGauge::PaintAsPie(Graphics::TBitmap* AnImage, const TRect& PaintRect)
{
...
void __fastcall TAZGauge::PaintAsNeedle(Graphics::TBitmap* AnImage, const TRect& PaintRect)
{
  Integer  MiddleX;
  Double   Angle;
  Integer  X, Y, W, H;
...
void __fastcall TAZGauge::SeTAZGaugeKind(TAZGaugeKind Value)
{
  if (Value != FKind){
      FKind = Value;
      Refresh();
...
void __fastcall TAZGauge::SetShowText(Boolean Value)
{
  if (Value != FShowText){
      FShowText = Value;
      Refresh();
...
void __fastcall TAZGauge::SetBorderStyle(TBorderStyle Value)
{
...
void __fastcall TAZGauge::SetForeColor(TColor Value)
{
  if (Value != FForeColor){
      FForeColor = Value;
      Refresh();
...
void __fastcall TAZGauge::SetBackColor(TColor Value)
{
  if (Value != FBackColor){
      FBackColor = Value;
      Refresh();
...
void __fastcall TAZGauge::SetMinValue(Longint Value)
{
  if (Value!= FMinValue){
    if (Value > FMaxValue)
    {
...
void __fastcall TAZGauge::SetMaxValue(Longint Value)
{
  if (Value){
	if (Value < FMinValue)
	{
...
void __fastcall TAZGauge::SetProgress(Longint Value)
{
  Longint  TempPercent;
...
void __fastcall TAZGauge::AddProgress(Longint Value)
{
